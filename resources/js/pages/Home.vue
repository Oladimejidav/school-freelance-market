<template>
  <div class="backwards">
    <div class="slide slide-1__background">
      <div>
        <img v-if="$matchMedia.xl" class="slide-1__left-dashed moveInRightDash duration--2" src="//images/logo.png" alt="">
      </div>
      <div class="slide-1__container">
        <div class="slide-1__first-block ">
          ...
          <p class="slide-1__paragraph moveInTop duration--1_5">
            Get your projects done on time, no delay.
          </p>
        ...
        <div class="slide-1__image-container moveInTop duration--2">
          ...
          <img v-else class="slide-1__image" src="/images/2-2-business-png-image.png" alt="">
        </div>
      </div>
      <div>
    ...
    <div class="slide slide-2__container">
      <div v-if="$matchMedia.xl" class="slide-2__left">
        <img class="slide-2__image" src="/images/396-mckinsey-21a0628-jir_1-removebg.png" alt="">
      </div>
      <div class="slide-2__right">
        ...
        <p class="slide-2__paragraph">
          Knowing the available projects that is currently posted on Cheaprank and the finished projects will determine your spirit!
...
export default {
  ...
  metaInfo () {
    return {
      title: 'Home',
      meta: [
        { name: 'description', content: 'Cheaprank: Freelance Marketplace for Freelancers. Get your projects done on time, no delay.' }
      ]
    }
  },
