<template>
  <div class="register-page--container" :class="{ 'lecturer-bg': lecturerRole }">
    ...
    <div class="resgiter-form--container" style="align-content:center;">
      ...
      <div class="login-role--container">
        <div>
          ...
          <label class="login-radio--label" for="login-student" @click="chooseStudent">Client</label>
        </div>
        <div>
          <input id="login-lecturer" v-model="form.role" class="login-radio" type="radio" value="Lecturer" name="role">
          <label class="login-radio--label" for="login-lecturer" @click="chooseLecturer">Freelancer</label>
        </div>
      </div>
      ...
      <form @submit.prevent="register" @keydown="form.onKeydown($event)">
        <div class="form__input--group">
          <div class="form-group__container">
            ...
            <div class="">
              <input v-model="form.first_name" :class="{ 'is-invalid': form.errors.has('first_name') }" class="form-group__input-text" type="text" name="first_name" placeholder="e.g., Smart" required>
          ...
          <div class="form-group__container">
            ...
            <div class="">
              <input v-model="form.last_name" :class="{ 'is-invalid': form.errors.has('last_name') }" class="form-group__input-text" type="text" name="last_name" placeholder="e.g., Joe" required>
        ...
        <div class="form-group__container">
          ...
          <div class="">
            <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }" class="form-group__input-text" type="email" name="email" placeholder="e.g., smartjoe@example.id" autocomplete="username" required>
      ...
      <div v-if="$matchMedia.xl" class="desktop-login__footer">
        All Rights Reserved. &copy; 2021 . | Cheaprank
      </div>
    </div>
  </div>
</template>
